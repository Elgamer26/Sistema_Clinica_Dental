            ...
            <div class="col-lg-auto ms-lg-auto">
                <ul class="list-inline list-inline-dots mb-0">
                    ...
                    <li class="list-inline-item">
                        <a target="_blank" class="link-secondary" rel="noopener">
...
<script>
    function ObtenerInfoUsuarioLogin() {
        $.ajax({
            type: "GET",
            ...
            success: function(response) {
                if (response.status == 200) {
                    ...
                    var baseUrl = "{{ asset('img/usuario') }}/";
                    var imageUrl = baseUrl + response.success[0]["foto"];
