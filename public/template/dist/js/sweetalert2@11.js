...
!(function (t, e) {
    ...
    function Ue(t, e) {
        ...
        if (n && t)
            if ("radio" === t.type)
                for (
                    var o = n.querySelectorAll('[name="'.concat(b.radio, '"]')),
                        i = 0;
                    i < o.length;
                    i++
                )
                ...
                [
                    {
                        ...
                        value: function (t) {
                            ...
                            Kn(i),
                                Object.freeze(i),
                                h.timeout &&
                                    (h.timeout.stop(), delete h.timeout),
